...
controller.prototype.POSTindex = async function () {
  let updating = ['name', 'desc', 'content', 'rating', 'img_landscape', 'is_active', 'is_hot']
...
controller.prototype.POSTedit = async function () {
  let updating = ['name', 'desc', 'content', 'rating', 'img_landscape', 'is_active', 'is_hot']
  let modeldata = rxdata.params.rxraw ? rxdata.params : this.preUpdate(updating, rxdata.params)

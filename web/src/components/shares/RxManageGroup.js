...
const { rxaget, rxChangeSlug, stringToColour, autoConvertTime, subString ,changeColorSVG} = global.rootRequire('classes/ulti')
      ...
      <div className='zchat_mangagerscreen'>
        ...
        <div className={`zchat_callscreen_main ${this.state.isShowPopupManageGroup ? 'visible' : 'invisible'}`}>
          ...
          <div className='zchat_mangagercenter'>
            <img className='zchat_mangagercenter_close' alt='' src={changeColorSVG('./images/default/icons/icon-close.png')} onClick={e => this.onClickStopCall()} />

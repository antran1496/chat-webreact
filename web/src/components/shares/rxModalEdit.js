...
class RxModalEdit extends Component {
    ...
    onSubmit(e) {
        ...
        if (!errorValidate) {
            this.props.onSubmitContact(this.state.addContactValue)
        }
    }
            ...
            <div className='zmodal-addfriend'>
                <div className='zmodal-addfriend-content'>
                    ...
                    <div className='zmodal-fill'>
                        ...
                        <input maxLength="50" className='zmodal-input' placeholder={translate('Enter your full name')}
                        ...
                        <input maxLength="50" className='zmodal-input zmodal-input-phone' placeholder='0000 000 000' disabled={this.state.flagEdit}

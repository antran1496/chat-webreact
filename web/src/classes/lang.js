...
let lang = {
  ...
  'Terms Of Service':'Điều Khoản Sử Dụng NetAlo',
  ...
  'New Channel':'Kênh trò chuyện mới',
  ...
  'Delete conversation Draft':'Xóa hội thoại nháp',
  ...
  'User name':'Tên tài khoản đăng nhập',
  'Full name':'Tên liên hệ',
  'Name is too short':'Tên quá ngắn',
  'Phone is invalid':'Số điện thoại ko hợp lệ',
  'Enter your full name':'Nhập tên liên hệ',
  'Enter your user name':'Nhập tên tài khoản',
  'Done':'Xong',
  ...
  'Join': 'Tham gia',
  'Joined': 'Đã tham gia',
  'Ongoing Group Call': 'Cuộc gọi nhóm đang diễn ra',
  'You were on a group call': 'Bạn đã tham gia cuộc gọi nhóm'
}

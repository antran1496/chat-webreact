...
export const renderBody = (vm) => {
  let checkValueInput = (vm.state.mess || rxaget(vm.state.imageTmp, 'base64', '')) ? true : false
  return (<div id="zchat_footer"
    ...
    {
      (rxaget(vm.state, 'mess_selected.message_id', '') && [1, 2].indexOf(vm.state.type_option) !== -1)
        ...
        <div className='zchat_box'>
          <div className='zchat_box'>
            ...
            <div className='zchat_footer-close' onClick={e => vm.closeReplyMessage()}>
              <img alt='icon-close' src={changeColorSVG('./images/default/icons/icon-close.png')} />
            </div>
          </div>
        </div>
      </div>
    ...
    <div className={(rxaget(vm.state.group, 'type', 0) === 4 && !vm.isLeader(vm.userid)) ? 'className_hiden':'zchat_footer-box' }>
      <div className='zmessage_option'>
          ...
          <div className='chat-wrapper'>
            <div className='message-wrapper'>  
              ...
              {/*(vm.state.imageTmp && vm.state.imageTmp.base64) && <div className='image_footer-close' onClick={e => vm.closeImageFooterLoader()}>
                <img alt='icon-close' src={changeColorSVG('./images/default/icons/icon-close.svg')} />
              </div>*/}
      ...
      <div className='zmessage_like'>
        {!checkValueInput && <div className='zfooter_btn'><img src={changeColorSVG('./images/default/icons/likeicon.svg')} alt='likeicon' className='neta-icons-btn neta-icon32 neta-filter_img_class' onClick={e => vm.sendLike()} /></div>}
        {checkValueInput && <span className='zfooter_sentchat'><img src={changeColorSVG('./images/default/icons/icon-sentmess.svg')} alt='' className='neta-icons-btn neta-icon32 neta-filter_img_class' onClick={e => vm.sendMessClick()}/></span>}
      </div>
    </div>

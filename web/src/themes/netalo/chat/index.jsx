...
const RxGroupCall = global.rootRequire('components/shares/rxGroupCall').default
      ...
      <div className='zchat_left'>
        <div className='zleft_menu'>
          <div className='zmenu_message'>
            <img src={changeColorSVG('./images/default/icons/chat-active.svg')} alt='' className='zmenu_icon icon filter_img_class' />
          </div>
          <div className='zmenu_call' onClick={()=>vm.props.setComp('call')}>
            <img src={changeColorSVG('./images/default/icons/call.svg')} alt='' className='zmenu_icon icon' />
          </div>

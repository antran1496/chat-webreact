...
const { rxChangeSlug ,changeColorSVG} = global.rootRequire('classes/ulti')
...
{/*        <div className='group-menu_item'>
          <div className ='group-item-head'>
            <img className='group_img_item filter_img_class' src={changeColorSVG('./images/default/icons/icon_edit.svg')}alt=''/>
          </div>
  ...
  <div className='zchat_left'>  
    <div className='zleft_menu'>
      ...
      <div className='zmenu_contact'>
        <img src={changeColorSVG('./images/default/icons/contact-active.svg')} className='zmenu_icon icon filter_img_class' alt='' />
      </div>
      <div className='zmenu_config' onClick={()=>vm.props.setComp('config')}>
        <img src={changeColorSVG('./images/default/icons/config.svg')} className='zmenu_icon icon' alt='' />
      </div>
    </div>
    ...
    {vm.state.groupsSearchBoxClickStatus === false && vm.state.searchValue.length === 0 ?
      ...
      />}
      {
        (global.rxu.get(vm.props, 'netaRegisteredUsers.data', []).length > 0) ?
          ...
          (<div>
            {
              (!vm.state.searchValue) && <div className='zgroup-emty'>
                <img className='icon176x80 filter_img_class' src={changeColorSVG('./images/default/icons/background-contact.svg')} alt='' />

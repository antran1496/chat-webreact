  ...
  <div className='zchat_left'>
    <div className='zleft_menu'>
      <div className='zmenu_message' onClick={()=>vm.props.setComp('chat')}>
        <img src={changeColorSVG('./images/default/icons/chat.svg')} alt='' className='zmenu_icon icon' />
      </div>
      <div className='zmenu_call'>
        <img src={changeColorSVG('./images/default/icons/call-active.svg')} alt='' className='zmenu_icon icon filter_img_class' />
      </div>
      <div className='zmenu_contact' onClick={()=>vm.props.setComp('contact')}>
        <img src={changeColorSVG('./images/default/icons/contact.svg')} alt='' className='zmenu_icon icon' />
      </div>
      <div className='zmenu_config' onClick={()=>vm.props.setComp('config')}>
        <img src={changeColorSVG('./images/default/icons/config.svg')} alt='' className='zmenu_icon icon' />
      </div>
    </div>
